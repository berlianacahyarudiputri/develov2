        ...
        <>
            ...
            <TitleCard title="Profile Settings" topMargin="mt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <InputText labelTitle="Nama" defaultValue="Fujianti Utami" updateFormValue={updateFormValue}/>
                    <InputText labelTitle="Email" defaultValue="fujianti@develov.com" updateFormValue={updateFormValue}/>
